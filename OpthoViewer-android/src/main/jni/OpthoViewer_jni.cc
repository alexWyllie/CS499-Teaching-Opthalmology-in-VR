...
inline jlong jptr(OpthoViewer::HelloCardboardApp* native_app) {
  return reinterpret_cast<intptr_t>(native_app);
}

inline OpthoViewer::HelloCardboardApp* native(jlong ptr) {
  return reinterpret_cast<OpthoViewer::HelloCardboardApp*>(ptr);
}
...
(JNIEnv* env, jobject obj, jobject asset_mgr) {
  return jptr(new OpthoViewer::HelloCardboardApp(javaVm, obj, asset_mgr));
}
